...
#define NDS_LOADER_IPC_BOOTSTUBARM7_CACHED		(NDS_LOADER_IPC_ARM7BIN_CACHED - (64*1024))	//0x023CC000	-> same as IWRAMBOOTCODE	(rwx)	: ORIGIN = 0x023CC000, LENGTH = 64K (arm7bootldr.bin) entry address
