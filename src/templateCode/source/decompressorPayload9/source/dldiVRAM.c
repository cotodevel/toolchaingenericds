...
const uint32  DLDI_MAGIC_NUMBER = 0xBF8DA5ED;	
const data_t dldiMagicString[12] = "\xED\xA5\x8D\xBF Chishm";	// Normal DLDI file
const data_t dldiMagicLoaderString[12] = "\xEE\xA5\x8D\xBF Chishm";	// Different to a normal DLDI file
...
bool dldiRelocateLoader(bool clearBSS, u32 DldiRelocatedAddress, u32 dldiSourceInRam, u32 dldiOutWriteAddress){
	...
	memcpy((uint32)pDH, (uint32)pAH, (uint32)dldiFileSize);
