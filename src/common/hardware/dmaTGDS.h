...
extern void dmaTransferHalfWordVBlank(sint32 dmachannel, uint32 source, uint32 dest, uint32 word_count);
extern void dmaTransferWordVBlank(sint32 dmachannel, uint32 source, uint32 dest, uint32 word_count);
#endif
