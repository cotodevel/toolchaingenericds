...
#define TGDS_GETEXTERNALCPU_COMMAND_MODE (u32)(0xFFFFAAC4)
	#define TGDS_EXTERNAL_COMMAND_MODE_INVALID (u32)(-1)
	#define TGDS_EXTERNAL_COMMAND_GET_CORE_WIRELESS_AVAILABILITY (u32)(1)
