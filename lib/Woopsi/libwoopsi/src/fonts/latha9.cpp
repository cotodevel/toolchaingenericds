...
static const u16 Latha9_glyphdata[281] = {
/* '!' */	0xFA00,
/* '"' */	0xB400,0x0000,
/* '#' */	0x55F5,0xFAA0,0x0000,
/* '$' */	0x7568,0xE2D5,0xC400,0x0000,
/* '%' */	0x4AC5,0x0428,0xD280,0x0000,
/* '&' */	0x3924,0x9C96,0x2740,0x0000,
/* ''' */	0xC000,
/* '(' */	0x2A49,0x2220,
/* ')' */	0x8892,0x4A80,
/* '*' */	0xEA80,0x0000,
...
/* '@' */	0x3C42,0x95AD,0xA9AA,0xBC43,0x3C00,
/* 'A' */	0x1050,0xA227,0xC8A0,0x8000,0x0000,
...
/* 'V' */	0x8305,0x1222,0x8504,0x0000,0x0000,
/* 'W' */	0x88CA,0x554A,0xA552,0xA888,0x0000,0x0000,
/* 'X' */	0x8A94,0x452A,0x2000,0x0000,
/* 'Y' */	0x8A94,0x4210,0x8000,0x0000,
/* 'Z' */	0xFC21,0x0842,0x0FC0,0x0000,
/* '[' */	0xEAAA,0xC000,
/* '\' */	0x9124,0x4800,
/* ']' */	0xD555,0xC000,
/* '^' */	0x5680,0x0000,
...
/* 'l' */	0xFE00,
/* 'm' */	0x0003,0xF499,0x3264,0x8000,0x0000,
...
static const u16 Latha9_offset[95] = {
    0,    1,    3,    6,   10,   14,   18,   19,   21,   23,   25,   29,   30,   32,   33,   35,
   38,   40,   43,   46,   50,   53,   56,   59,   62,   65,   66,   67,   69,   72,   74,   78,
   83,   88,   91,   95,   99,  103,  106,  110,  114,  115,  118,  122,  125,  130,  134,  138,
  141,  145,  149,  152,  156,  160,  165,  171,  175,  179,  183,  185,  187,  189,  191,  195,
  197,  200,  203,  206,  209,  212,  214,  217,  220,  221,  222,  225,  226,  231,  234,  237,
  240,  243,  245,  248,  250,  253,  257,  261,  264,  268,  270,  272,  273,  275,  278
};

static const u8 Latha9_width[95] = {
...
Latha9::Latha9(u8 fixedWidth) : PackedFont1 (
	33,
	127,
	Latha9_glyphdata,
	Latha9_offset,
