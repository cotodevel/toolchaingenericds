#ifndef _SCROLLBARHORIZONTAL_TEST_H_
#define _SCROLLBARHORIZONTAL_TEST_H_
...
class ScrollbarHorizontalTest : public Woopsi, public GadgetEventHandler {
public:
...
private:
	...
	Button* _disable;
	Button* _dimensions;
	ScrollbarHorizontal* _scrollbar;
