...
void CycleTest::startup() {
	...
	// Add cycle button
	_cycleButton = new CycleButton(30, 30, 100, 20);
	_cycleButton->addOption("Option 1", 1);
	_cycleButton->addOption("Option 2", 2);
	_cycleButton->addOption("Option 3", 3);
	_cycleButton->addOption("Option 4", 4);
	_cycleButton->addOption("Option 5", 5);
	_cycleButton->addOption("Option 6", 6);
	_cycleButton->addOption("Option 7", 7);
	_cycleButton->addOption("Option 8", 8);
	_cycleButton->addOption("Option 9", 9);
	_cycleButton->addOption("Option 10", 10);
	window->addGadget(_cycleButton);
	_cycleButton->addGadgetEventHandler(this);
	_cycleButton->setDoubleClickable(true);
...
void CycleTest::handleClickEvent(const GadgetEventArgs& e) {
...
void CycleTest::handleDragEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleReleaseEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleReleaseOutsideEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleKeyPressEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleKeyReleaseEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleLidOpenEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleLidCloseEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleFocusEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleBlurEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleCloseEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
			Debug::printf("Closed");
			break;
...
void CycleTest::handleHideEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
			Debug::printf("Hidden");
			break;
...
void CycleTest::handleShowEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
			Debug::printf("Shown");
			break;
...
void CycleTest::handleEnableEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleDisableEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleValueChangeEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleResizeEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleMoveEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
			Debug::printf("Moved");
			break;
...
void CycleTest::handleScrollEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleShiftClickEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleContextMenuSelectionEvent(const ContextMenuEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleDoubleClickEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleShelveEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleUnshelveEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleActionEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
			Debug::printf("Action");
			break;
		...
		case 6:
			{
				u16 newPos;
				if (_cycleButton->getX() == 10) {
					newPos = 30;
				} else {
					newPos = 10;
				}
				_cycleButton->moveTo(newPos, newPos);
				break;
			}
		case 7:
		...
		case 11:
			{
				...
				_cycleButton->changeDimensions(newPos, newPos, newPos, newPos);
				break;
			}
	}
}

void CycleTest::handleMoveForwardEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
...
void CycleTest::handleMoveBackwardEvent(const GadgetEventArgs& e) {
	switch (e.getSource()->getRefcon()) {
		case 1:
