#ifndef _BITMAP_BUTTON_TEST_H_
#define _BITMAP_BUTTON_TEST_H_
...
class BitmapButtonTest : public Woopsi, public GadgetEventHandler {
public:
...
private:
	...
	Button* _disable;
	Button* _dimensions;
	BitmapButton* _button;
	BitmapWrapper* _bitmap;
